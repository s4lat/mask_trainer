...
class AboutDialog(QtWidgets.QDialog):
    ...
    def retranslateUi(self, Dialog):
        ...
        #self.header.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:48pt;\">TextLabel</span></p></body></html>"))
        self.label.setText(_translate("Dialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600;\">MaskTrainer v1.0</span></p><p align=\"center\"><span style=\" font-size:18pt;\">Тренажер сопоставления маски и имени файла</span></p><p align=\"center\"><span style=\" font-size:18pt;\">Распространяется бесплатно</span></p><p align=\"center\"><span style=\" font-size:18pt;\">Email: zakazchikm@gmail.com</span></p><p align=\"center\"><span style=\" font-size:18pt;\">Автор программы: Заказчик М.Н</span></p><p align=\"right\"><span style=\" font-family:\'AppleSDGothicNeo-Regular,lucida grande,tahoma,verdana,arial,sans-serif,AppleColorEmoji,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,NotoColorEmoji,EmojiSymbols,Symbola,Noto,Android Emoji,AndroidEmoji,Arial Unicode MS,Zapf Dingbats\'; font-size:12px; color:#000000;\">Copyright © 2019 Заказчик М.Н.</span></p></body></html>"))
